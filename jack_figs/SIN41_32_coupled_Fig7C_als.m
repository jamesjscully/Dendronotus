...
t2=50*1000; % this time is in msec
...
V1= V1 +step*(-0.8*Iapp*heaviside(tt-t1)*heaviside(t2+50-tt)+4*((0.1*(50-(127*V1/105+8265/105))/(exp((50 - (127*V1/105 ...
...
V2= V2 +step*(-0.8*Iapp*heaviside(tt-t1)*heaviside(t2-tt)+4*((0.1*(50-(127*V2/105+8265/105))/(exp((50 - (127*V2/105 ...
...
xc=0.215;
a=annotation('arrow', [xc xc], [415/560 395/560]); 
a.Color = 'red';
a.LineWidth = 4; 
a=annotation('arrow', [xc xc], [80/560 100/560]); 
a.Color = 'red';
...
a.Color = 'red';
a.LineWidth = 4; 
a=annotation('arrow', [xc xc], [395/560 415/560]); 
a.Color = 'r';
a.LineWidth = 4;
...
% End of stacked‐trace plotting
%saveas(gcf, '5f.jpg');
%exportgraphics(fig, '7c_als.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')