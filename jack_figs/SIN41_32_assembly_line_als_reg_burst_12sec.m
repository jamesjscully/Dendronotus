...
alpha1 = 0.007; beta1 =  0.001; scale1=alpha1/(alpha1+beta1);
...
xlim([0+10 tmax-23+10])     % Extended to show labels
...
%exportgraphics(fig, 'norm_swim_12sec.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')
