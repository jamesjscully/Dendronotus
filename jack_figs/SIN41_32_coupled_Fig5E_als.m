...
Iapp=0.33;
t1=24.2*1000; % this time is in msec
...
V4 =V4 +step*(Iapp*heaviside(tt-t1)*heaviside(t2-tt)+4*((0.1*(50-(127*V4/105+8265/105))/(exp((50 - (127*V4/105 ...
...
% a.Color = 'red';
% a.LineWidth = 4; 
a=annotation('arrow', [xc xc], [70/560 90/560]); 
a.Color = 'red';
a.LineWidth = 4; 
...
%saveas(gcf, '5e.jpg');
%exportgraphics(fig, '5e_als1.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')