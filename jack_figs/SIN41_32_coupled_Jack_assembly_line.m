...
V3 = -44; V2 = -44; Ca3 = 0.1; Ca2 = 1.3; h3 = 0; h2 = 0; n3 = 0; n2 = 0; y2 = 0;
...
set(gcf, 'Position',  [100, 100, 1500, 500]) % Larger figure size for 4 cells
...
plot(time, ss1/scale1*synscale + offset - 85, 'Color', [0, 0, 0.6], 'LineWidth', 0.8)
...
plot(time, ss2/scale2*synscale + offset - 85, 'Color', [0, 0, 0.99], 'LineWidth', 0.8)
...
plot(time, ss3/scale3*synscale + offset - 85, 'Color', [0.6, 0, 0], 'LineWidth', 0.8)
...
plot(time, ss4/scale4*synscale + offset - 85, 'Color', [0.9, 0, 0], 'LineWidth', 0.8)

% Set axis limits and labels
xlim([0 tmax*1.05])     % Extended to show labels
ylim([-35 560])         % Adjusted to fit all traces
...
plot([x_start, x_start], [y_start, y_start + voltage_height], 'k', 'LineWidth', 2)        % Vertical line
plot([x_start, x_start - time_length], [y_start, y_start], 'k', 'LineWidth', 2)           % Horizontal line

% Add scale labels
text(x_start - time_length/2, y_start - 15, [num2str(time_length) ' s'], 'HorizontalAlignment', 'center', 'FontSize', 12)
text(x_start + 1, y_start + voltage_height/2, [num2str(voltage_height) ' mV'], 'VerticalAlignment', 'middle', 'FontSize', 12)
