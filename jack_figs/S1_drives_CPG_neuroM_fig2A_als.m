...
Ca0=Ca0+step*(0.0003*(0.0085*x0*(140-V0+Ca_shift0*abs(cos(0.000034*(tt+20000))))-Ca0)); 
...
plot(time, ss0/scale0*synscale + offset - 85, 'Color', [0.4, .4, .4], 'LineWidth', 1.5)
...
xlim([36 tmax-25])     % Extended to show labels
...
%period 10=12 sec
%exportgraphics(fig, 's1_Fig2A_drives_cpg.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')
