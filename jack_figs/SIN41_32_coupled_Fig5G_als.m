...
Iapp=-0.158;
t1=23*1000; % this time is in msec
...
for i=1:nt
 ...
 V3 =V3 +step*(Iapp*heaviside(tt-t1)*heaviside(t2-tt)+4*((0.1*(50-(127*V3/105+8265/105))/(exp((50 - (127*V3/105 ...
...
V4 =V4 +step*(Iapp*heaviside(tt-t1)*heaviside(t2+200-tt)+4*((0.1*(50-(127*V4/105+8265/105))/(exp((50 - (127*V4/105 ...
...
a.Color = 'red';
a.LineWidth = 4; 
a=annotation('arrow', [xc xc], [90/560 70/560]); 
a.Color = 'red';
a.LineWidth = 4; 

xc=0.656;
a=annotation('arrow', [xc xc], [170/560 190/560]); 
a.Color = 'red';
a.LineWidth = 4; 
a=annotation('arrow', [xc xc], [65/560 85/560]); 
a.Color = 'red';
a.LineWidth = 4; 
...
%saveas(gcf, '5f.jpg');
%exportgraphics(fig, '5g_als.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')