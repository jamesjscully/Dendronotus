...
V1= V1 +step*(4*((0.1*(50-(127*V1/105+8265/105))/(exp((50 - (127*V1/105 ...
    ...
    -g41*(V1-30)*s4/scale4*(1+1.1*s0/scale0)  -g12*(V1+80)*s21/scale12  +gelec*(V4-V1)+rnd2(i));
...
xlim([8.5 tmax-0])     % Extended to show labels
...
%period 10=12 sec
%exportgraphics(fig, 's1_Fig3B_drives_cpg.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')
