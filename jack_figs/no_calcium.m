...
V3= -44; V2= -44; Ca3=.3; Ca2=1.3; h3 =0; h2 =0; n3 =0; n2 =0; 
...
Ca4=Ca4+step*(0.00000003*(0.0085*x4*(140-V4+Ca_shift4)-Ca4));
Ca1=Ca1+step*(0.00000003*(0.0085*x1*(140-V1+Ca_shift1)-Ca1));
Ca3=Ca3+step*(0.00000003*(0.0085*x3*(140-V3+Ca_shift3)-Ca3));
Ca2=Ca2+step*(0.00000003*(0.0085*x2*(140-V2+Ca_shift2)-Ca2));
...
set(gcf, 'Position', [100, 100, 1600, 500]);  % larger window
hold on;
...
ylabel('Voltage / Activation', 'FontSize', 16);
box on;
...
time_len  = 2;
volt_h    = 50;
plot([x_start, x_start], [y_start, y_start + volt_h], 'k', 'LineWidth', 2);
plot([x_start, x_start - time_len], [y_start, y_start], 'k', 'LineWidth', 2);
text(x_start - time_len/2, y_start - 15, [num2str(time_len) ' s'], 'HorizontalAlignment', 'center', 'FontSize', 12);
text(x_start + .2, y_start + volt_h/2, [num2str(volt_h) ' mV'], 'VerticalAlignment', 'middle', 'FontSize', 12);

% End of stacked‐trace plotting
saveas(gcf, 'no_calcium.jpg');