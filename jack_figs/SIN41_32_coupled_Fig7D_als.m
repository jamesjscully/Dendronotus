...
t2=145*1000; % this time is in msec
...
V1= V1 +step*(0.9*Iapp*heaviside(tt-t1)*heaviside(t2+250-tt)+4*((0.1*(50-(127*V1/105+8265/105))/(exp((50 - (127*V1/105 ...
...
V3 =V3 +step*(Iapp*heaviside(tt-t1)*heaviside(t2-50-tt)+4*((0.1*(50-(127*V3/105+8265/105))/(exp((50 - (127*V3/105 ...
...
V4 =V4 +step*(Iapp*heaviside(tt+10-t1)*heaviside(t2+20-tt)+4*((0.1*(50-(127*V4/105+8265/105))/(exp((50 - (127*V4/105 ...
...
text(x_start + .2, yh_start + volt_h/2, [ num2str(volt_h) ' mV'], 'VerticalAlignment', 'middle', 'FontSize', 15);
...
a=annotation('arrow', [xc xc], [410/560 430/560]); 
a.Color = 'red';
a.LineWidth = 4; 
a=annotation('arrow', [xc xc], [300/560 320/560]); 
a.Color = 'red';
a.LineWidth = 4; 
...
a=annotation('arrow', [xc xc], [320/560 300/560]); 
a.Color = 'red';
a.LineWidth = 4; 
a=annotation('arrow', [xc xc], [430/560 410/560]); 
a.Color = 'r';
a.LineWidth = 4;
...
% End of stacked‐trace plotting
%saveas(gcf, '5f.jpg');
%exportgraphics(fig, '7d_als1.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')