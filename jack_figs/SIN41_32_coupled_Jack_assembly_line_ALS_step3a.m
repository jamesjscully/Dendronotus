...
plot(time, ss3/scale3*synscale/2 + offset - 100, 'Color', [0.6, 0, 0], 'LineWidth', 0.8)
...
xlim([0 tmax-3.2])     % Extended to show labels
...
x_start = tmax-23.9;  % X position for start of scale
y_start   = 50;
yh_start   = y_start+5;
...
exportgraphics(fig, 'assembly_step3als.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')
%
