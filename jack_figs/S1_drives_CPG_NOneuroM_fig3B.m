...
alpha4 = 0.055; beta4 =  0.008; scale4=alpha4/(alpha4+beta4);
...
alpha1 = 0.012;  beta1 =  0.001; scale1=alpha1/(alpha1+beta1);
...
Ca_shift4 = -3;
Ca_shift1 = -6;
Ca_shift3 = Ca_shift4+2;
Ca_shift2 = Ca_shift1+3;
x_shift =  -4;
...
Iapp=0.2;    
t1=13*1000; % this time is in msec
...
% Initial values
V4= -44; V1= -44; Ca4=1.0; Ca1=1.3; h4 =0; h1 =0; n4 =0; n1 =0; y1=0; x4 =.99; x1 =.92; s4 =0; s1 =0; s12=0; s43=0;
V3= -44; V2= -44; Ca3=1.2; Ca2=1.3; h3 =0; h2 =0; n3 =0; n2 =0; y2=0; x3 =.89; x2 =.92; s3 =0; s2 =0; s21=0; s34=0;
V0= -44; Ca0=1.4; h0 =0; n0 =0; s0=0; x0=0;
...
V0= V0 +step*(Iapp*heaviside(tt-t1)*heaviside(t2+1250-tt)+4*((0.1*(50-(127*V0/105+8265/105))/(exp((50 - (127*V0/105 ...
    ...
    +0.03*Ca0/(.5 + Ca0)*(-75 - V0)+0.003*(-40 - V0)+rnd2(i));
...
V1= V1 +step*(4*((0.1*(50-(127*V1/105+8265/105))/(exp((50 - (127*V1/105 ...
    ...
    -g41*(V1-30)*s4/scale4*(1+1.01*s0/scale0)  -g12*(V1+80)*s21/scale12  +gelec*(V4-V1)+rnd2(i));
...
plot(time, ss21/scale12*synscale + offset - 80, 'Color', [0., 0.0, 0.99], 'LineWidth', 1)
...
text(x_start + .5, yh_start + volt_h/2, [num2str(volt_h) ' mV'], 'VerticalAlignment', 'middle', 'FontSize', 14);


% Set axis limits and labels
xlim([8.5 tmax-10])     % Extended to show labels
ylim([70 720])         % Adjusted to fit all traces
...
%period 10=12 sec
%exportgraphics(fig, 's1_drives_CPG_Fig3B_No_NM.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')
