...
Iapp=-0.51;
t1=22*1000; % this time is in msec
t2=45*1000; % this time is in msec
...
V3= -44; V2= -44; Ca3=.2; Ca2=1.3; h3 =0; h2 =0; n3 =0; n2 =0; 
...
V2= V2 +step*(Iapp*heaviside(tt-t1)*heaviside(t2-100-tt)+4*((0.1*(50-(127*V2/105+8265/105))/(exp((50 - (127*V2/105 ...
...
set(gcf, 'Position', [100, 100, 1500, 500]);  % larger window
hold on;

% Define offsets, scale factors, and colors for each trace
offsets      = [520, 370, 230, 115];
...
for k = 1:4
    off = offsets(k);
    plot(time, syn_traces{k} + off, 'Color', colors{k}, 'LineWidth', 1.7);
end
...
xc=0.27;
a=annotation('arrow', [xc xc], [410/560 390/560]); 
a.Color = 'red';
a.LineWidth = 4; 
a=annotation('arrow', [xc xc], [330/560 310/560]); 
a.Color = 'red';
a.LineWidth = 4; 

xc=0.617;
a=annotation('arrow', [xc xc], [390/560 410/560]); 
a.Color = 'red';
a.LineWidth = 4; 
a=annotation('arrow', [xc xc], [280/560 300/560]); 
a.Color = 'red';
a.LineWidth = 4; 


% End of stacked‐trace plotting
%% saveas(gcf, '5c.jpg');% End of stacked‐trace plotting
%saveas(gcf, '5a.jpg');exportgraphics(fig, '5c_als1.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')