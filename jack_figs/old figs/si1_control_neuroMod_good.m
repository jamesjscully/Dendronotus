...
x0 = 0; x1 = .6; x2 = .6; x3 = .6; x4 = .6;
Ca0 = .3; Ca1 = 1.; Ca2 = 1.; Ca3 = 1.1; Ca4 = 1.;
h0 = 0; h1 = 0; h2 = 0; h3 = 0; h4 = 0;
n0 = 0; n1 = 0; n2 = 0; n3 = 0; n4 = 0;
y1 = 0; y2 = 0;
s0 = 0;s1 = 0;s2 = 0;s3 = 0;s4 = 0;s12 = 0;s21 = 0;s34 = 0;s43 = 0;sm = .9;
...
V0new= V0 +step*(4*((0.1*(50-(127*V0/105+8265/105))/(exp((50 - (127*V0/105 ...
...
V1new= V1 +step*(4*((0.1*(50-(127*V1/105+8265/105))/(exp((50 - (127*V1/105 ...
    ...
    -g41*(V1-30)*s4/scalex ... % excitation from si3
...
V2new= V2 +step*(4*((0.1*(50-(127*V2/105+8265/105))/(exp((50 - (127*V2/105 ...
    ...
    -g32*(V2-30)*s3/scalex ... % excitation from si3
...
%txpo = text(-4.4,25,'B','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')
 ...
 subplot(6,1,5)
 plot(time,ss4/scalex,'Color',[0.6 0.0 0.6],'LineWidth',1.5)
 hold on
 plot(time,ss1/scalei,'Color',[0.0 0.  0.6],'LineWidth',1.5)
 hold on
 plot(time,ss12/scale2,'Color',[0.0 0.5 0.0],'LineWidth',0.5)
 hold on
 plot(time,ss43/scale3,'Color',[0.1 0.1 0.1],'LineWidth',0.5)
 hold on
 plot(time,ss0/scale1,'Color',[0.3 0.4 0.5],'LineWidth',1.5)
 hold on
 plot(time,ssm/scalem,'Color',[0.7, 0.7, 0.7], 'LineWidth', 1.5)
 %ylim([-0.2  .9])
 xlim([0 tmax])
 box on
