...
t1=55*1000; % this time is in msec
...
V1= V1 +step*(Iapp*heaviside(tt-t1)*heaviside(t2+200-tt)+4*((0.1*(50-(127*V1/105+8265/105))/(exp((50 - (127*V1/105 ...
...
text(x_start + 1, y_start + volt_h/2, [num2str(volt_h) ' mV'], 'VerticalAlignment', 'middle', 'FontSize', 12);
