...
Ca_shift2 = Ca_shift1+4;
x_shift =  -4;

Iapp=.1;

t1=15*1000; % this time is in msec
t2=125*1000; % this time is in msec
...
V1= V1 +step*(Iapp*heaviside(tt-t1)*heaviside(t2+150-tt)+4*((0.1*(50-(127*V1/105+8265/105))/(exp((50 - (127*V1/105 ...
...
V3 =V3 +step*(0*Iapp*heaviside(tt-t1)*heaviside(t2-50-tt)+4*((0.1*(50-(127*V3/105+8265/105))/(exp((50 - (127*V3/105 ...
...
V4 =V4 +step*(0*Iapp*heaviside(tt+10-t1)*heaviside(t2+20-tt)+4*((0.1*(50-(127*V4/105+8265/105))/(exp((50 - (127*V4/105 ...
