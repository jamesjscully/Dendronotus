clear all 
tmax=75; % max time in seconds

gelec=0.002;

%----excitation from Si3s---------------
alpha4 = 0.024;  beta4 =  0.001; scale4=alpha4/(alpha4+beta4); 
alpha3 = alpha4; beta3 =  beta4; scale3=alpha3/(alpha3+beta3);

g41=0.005; g32=g41;

% inhibition from Si2s 
alpha1 = 0.015;  beta1 =  0.0009; scale1=alpha1/(alpha1+beta1);
alpha2 = alpha1; beta2 = beta1;   scale2=alpha2/(alpha2+beta2);

g14=0.005; g23=g14;

%----- inhibition between Si3s---------------
alpha34=0.01; beta34= 0.001; scale34=alpha34/(alpha34+beta34);

g34=0.005; g43=g34;

%-----inhibition between Si2s----
alpha12=0.05; beta12= 0.01; scale12=alpha12/(alpha12+beta12);
...
t1=5*1000; % this time is in msec
...
% Initial values
V4= -40; V1= -40; Ca4=1.2; Ca1=1.13; h4 =0; h1 =0; n4 =0; n1 =0; 
...
V3 =V3 +step*(Iapp*heaviside(tt-400-t1)*heaviside(t2-tt)+4*((0.1*(50-(127*V3/105+8265/105))/(exp((50 - (127*V3/105 ...
...
V4 =V4 +step*(Iapp*heaviside(tt+5-t1)*heaviside(t2-tt)+4*((0.1*(50-(127*V4/105+8265/105))/(exp((50 - (127*V4/105 ...
...
a.Color = 'red';
a.LineWidth = 4; 
a=annotation('arrow', [xc xc], [75/560 95/560]); 
a.Color = 'red';
a.LineWidth = 4; 


xc=0.785;
a=annotation('arrow', [xc xc], [205/560 185/560]); 
a.Color = 'red';
a.LineWidth = 4; 
a=annotation('arrow', [xc xc], [95/560 75/560]); 
a.Color = 'red';
a.LineWidth = 4; 
...
% End of stacked‐trace plotting
%saveas(gcf, '5f.jpg');
%exportgraphics(fig, '7b_als2.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')