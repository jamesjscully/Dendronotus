...
%alpha1 = 0.01; beta1 =  0.0008; scale1=alpha1/(alpha1+beta1);
alpha1 = 0.005; beta1 =  0.0005; scale1=alpha1/(alpha1+beta1);
alpha1 = 0.015; beta1 =  0.001; scale1=alpha1/(alpha1+beta1);
...
%alpha12=0.05; beta12= 0.005; scale12=alpha12/(alpha12+beta12);  % inh 12 and 21 same
% same as above
...
xlim([0 tmax-23])     % Extended to show labels
...
exportgraphics(fig, 'norm_swim_2sec.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')
