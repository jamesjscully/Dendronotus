...
Iapp=.18;
t1=8*1000; % this time is in msec
t2=53.3*1000; % this time is in msec
...
V3 =V3 +step*(.998*Iapp*heaviside(tt-t1)*heaviside(t2-50-tt)+4*((0.1*(50-(127*V3/105+8265/105))/(exp((50 - (127*V3/105 ...
...
V4 =V4 +step*(Iapp*heaviside(tt-400-t1)*heaviside(t2+20-tt)+4*((0.1*(50-(127*V4/105+8265/105))/(exp((50 - (127*V4/105 ...
...
% End of stacked‐trace plotting
%saveas(gcf, '5f.jpg');
%exportgraphics(fig, '7b_als1.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')