...
alpha1 = 0.0075; beta1 =  0.001; scale1=alpha1/(alpha1+beta1);
...
set(gcf, 'Position',  [10, 300, 1500, 800]); % Larger figure size for 4 cells
...
text(x_start + .1, yh_start + volt_h/2, [num2str(volt_h) ' mV'], 'VerticalAlignment', 'middle', 'FontSize', 18);
...
xlim([0+11.5 tmax-11.])     % Extended to show labels
...
%period 10=12 sec
%exportgraphics(fig, 'norm_swim_9sec.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')
