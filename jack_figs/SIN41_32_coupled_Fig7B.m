...
V1= V1 +step*(0.95*Iapp*heaviside(tt-t1)*heaviside(t2+1250-tt)+4*((0.1*(50-(127*V1/105+8265/105))/(exp((50 - (127*V1/105 ...
...
xc=0.162;
a=annotation('arrow', [xc xc], [400/560 420/560]); 
 a.Color = 'red';
 a.LineWidth = 4; 
...
xc=0.86;
 a=annotation('arrow', [xc xc], [420/560 400/560]); 
 a.Color = 'red';
 a.LineWidth = 4; 
a=annotation('arrow', [xc xc], [300/560 280/560]); 
a.Color = 'red';
a.LineWidth = 4; 
