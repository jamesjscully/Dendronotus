...
V0= -44; Ca0=.2; h0 =0; n0 =0; s0=0; x0=0;
...
time=zeros(nt1,1);vv4=time;vv1=time;ss4=time;ss1=time;Caa4=time; Caa1=time;xx4=time;xx1=time; vv3=time;vv2=time;ss3=time;ss2=time;Caa3=time;
Caa2=time;xx3=time;xx2=time; ss12=time; ss21=time; ss34=time; ss43=time; Caa0=time;xx0=time;vv0=time;ss0=time;
...
V0= V0 +step*(4*((0.1*(50-(127*V0/105+8265/105))/(exp((50 - (127*V0/105 ...
...
V3 =V3 +step*(4*((0.1*(50-(127*V3/105+8265/105))/(exp((50 - (127*V3/105 ...
 ...
 V4 =V4 +step*(4*((0.1*(50-(127*V4/105+8265/105))/(exp((50 - (127*V4/105 ...
    ...
    -g14*(V4+80)*s1/scale1 -g34*(V4+80)*s34/scale34 +gelec*(V1-V4)+rnd1(i)   -g0*(V3-40)*s0/scale0);


Ca0=Ca0+step*(0.0003*(0.0085*x0*(140-V0+Ca_shift0*abs(cos(0.000034*tt)))-Ca0)); 
...
s0 =s0+step*(alpha0*(1-s0)/(1+exp(-20*(V0+20)))-beta0*s0);
...
xlim([42 tmax-0])     % Extended to show labels
ylim([90 720])         % Adjusted to fit all traces
