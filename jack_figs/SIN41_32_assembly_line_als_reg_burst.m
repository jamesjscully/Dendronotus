...
g41=0;
g41=.008; g32=g41;
% increasing - no much difference
%g41=.01; g32=g41;
% increasing - no much difference in burst duraction but looks depolar ugly
%g41=.02; g32=g41;
...
g34=0.00;
g34=0.015; g43=g34;
% slower burts to 5 sec
%g34=0.02; g43=g34;
% slower burts to 8 sec 
% g34=0.04; g43=g34;
% slower burts to 25 sec and chaos/unstable 
% g34=0.05; g43=g34;
...
g21=0.00; 
g21=0.005; g12=g21;
% Incresing g21 increases burst duration to 6 sec from 4
%g21=0.015; g12=g21;
% Incresing g21 increases burst duration to 7 sec from 4
%g21=0.5; g12=g21;
% Incresing g21 increases burst duration to 8 
%g21=5; g12=g21;
...
% same fast 4s burst
%alpha4 = 0.2;  beta4 =  0.005;  scale4=alpha4/(alpha4+beta4);
%  slower 5s burst
%alpha4 = 0.06;  beta4 =  0.005;  scale4=alpha4/(alpha4+beta4);
% same 5s burst
%alpha4 = 0.07;  beta4 =  0.005;  scale4=alpha4/(alpha4+beta4);
...
% slower burts to 4 sec from 3 sec
%alpha1 = 0.01; beta1 =  0.001; scale1=alpha1/(alpha1+beta1);
% increasing it further shortens the burt back to 2 sec
%alpha1 = 0.02; beta1 =  0.001; scale1=alpha1/(alpha1+beta1);
% decreasing makes bursts  longer 5 sec and soon unstable 
%alpha1 = 0.008; beta1 =  0.001; scale1=alpha1/(alpha1+beta1);
% sorter and unstable
%alpha1 = 0.015; beta1 =  0.0005; scale1=alpha1/(alpha1+beta1);
...
% burst ~ 4 sec 
%alpha34=0.3; beta34=0.005;   scale34=alpha34/(alpha34+beta34); % inh 34 and 43 same
% burst ~ 5 sec 
%alpha34=3; beta34=0.005;   scale34=alpha34/(alpha34+beta34); % inh 34 and 43 same
% same burst ~ 3 sec 
%alpha34=0.0001; beta34=0.005;   scale34=alpha34/(alpha34+beta34); % inh 34 and 43 same
% same burst ~ 5 sec 
%alpha34=0.0001; beta34=0.001;   scale34=alpha34/(alpha34+beta34); % inh 34 and 43 same
% same burst ~ 6 sec unstable or chaotic 
%alpha34=0.001; beta34=0.0001;   scale34=alpha34/(alpha34+beta34); % inh 34 and 43 same


%--inh---12 Si1/2----between-----
alpha12=0.005; beta12= 0.005; scale12=alpha12/(alpha12+beta12);  % inh 12 and 21 same
% same as above
%alpha12=0.1; beta12= 0.005; scale12=alpha12/(alpha12+beta12);  % inh 12 and 21 same
% burst 4 sec not 3
%alpha12=0.01; beta12= 0.001; scale12=alpha12/(alpha12+beta12);  % inh 12 and 21 same
...
set(gcf, 'Position',  [100, 100, 1500, 800]); % Larger figure size for 4 cells
...
plot(time, ss1/scale1*synscale + offset - 85, 'Color', [0, 0, 0.6], 'LineWidth', 1)
...
plot(time, ss2/scale2*synscale + offset - 85, 'Color', [0, 0, 0.99], 'LineWidth', 1.)
...
plot(time, ss3/scale3*synscale + offset - 85, 'Color', [0.6, 0, 0], 'LineWidth', 1)
...
plot(time, ss4/scale4*synscale + offset - 85, 'Color', [0.9, 0, 0], 'LineWidth', 1)

% Set axis limits and labels
xlim([0 tmax-5.3])     % Extended to show labels
...
text(x_start - 1.3, yh_start + volt_h/2, [num2str(volt_h) ' mV'], 'VerticalAlignment', 'middle', 'FontSize', 18);
