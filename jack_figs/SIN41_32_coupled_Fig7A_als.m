...
Ca_shift4 = 35;
Ca_shift3 = Ca_shift4-4;

x_shift =  -4;

Iapp=.11;
t1=16.5*1000; % this time is in msec
t2=88*1000; % this time is in msec
...
V2= V2 +step*(0.97*Iapp*heaviside(tt-t1-1000)*heaviside(t2-tt)+4*((0.1*(50-(127*V2/105+8265/105))/(exp((50 - (127*V2/105 ...
...
%saveas(gcf, '7a.jpg');
%exportgraphics(fig, '7a_als1.jpg', 'Resolution', 75,'ContentType', 'image', 'BackgroundColor', 'white')