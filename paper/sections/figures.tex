...
\caption{{\bf Si1-dependent burst-frequency control is better matched by presynaptic modulation than by postsynaptic conductance scaling.}
...
Grey circles and grey fit line show digitized points from the published biological summary, black triangles and black fit line show measurements extracted directly from the representative biological Si1/Si2 trace pair, and blue circles and red squares show matched model measurements from representative presynaptic and postsynaptic simulations, respectively.
(C) Gain scan during sustained drive.
Presynaptic modulation of the logistic Si3$\to$Si2 accumulation-rate parameter $\alpha$ produces a broader, smoother increase in burst frequency, whereas postsynaptic modulation of effective synaptic conductance occupies a narrower band of frequencies over the same scan.
Faint points show individual measured intervals; saturated markers show gain-wise means.
(E) Representative biological and model traces.
...
The scale bar in panel E denotes 20~s and 50~mV.}
