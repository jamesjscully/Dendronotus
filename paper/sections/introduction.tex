...
Third, Si1-linked neuromodulation of the Si3$\to$Si2 pathway provides a plausible mechanism for graded frequency control during sustained drive, and both presynaptic and postsynaptic implementations can be evaluated within the same modeling framework.
