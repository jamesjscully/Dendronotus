...
Presynaptic modulation of the accumulation rate parameter $\alpha$ in the logistic Si3$\to$Si2 excitatory synapses produces a broader, smoother control of burst frequency during sustained drive (Fig.~\ref{fig:si1_neuromod}C), whereas postsynaptic modulation of $g_{syn}$ in the same synapses occupies a narrower and less graded response band.
...
Our results confirm this: presynaptic modulation of release kinetics produces smoother, more graded frequency changes during ongoing drive (Fig.~\ref{fig:si1_neuromod}C), whereas postsynaptic conductance modulation is less effective at spanning the biological control range summarized in Fig.~\ref{fig:si1_neuromod}B.
