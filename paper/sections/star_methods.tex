...
All simulations were performed using custom MATLAB code.
Differential equations were integrated using fixed-step forward Euler updates with a timestep of 0.1\,ms and traces saved every 2\,ms.
