%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%  Manuscript 7 - Dendronotus CPG Model
...
central pattern generator, CPG, Dendronotus iris, neural oscillation, synaptic dynamics, frequency modulation, half-center oscillator, computational model

%%% Introduction
\input{sections/introduction}

%%% Results
\input{sections/results_subcircuits}
\input{sections/results_assembly}
\input{sections/results_validations}
\input{sections/results_control}
