...
%txpo = text(-4.4,25,'B','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')
 ...
 subplot(6,1,5)
 plot(time,ss3/scale3,'Color',[0.6 0.0 0.6],'LineWidth',1.5)
 hold on
 plot(time,ss2/scale2,'Color',[0.0 0.  0.9],'LineWidth',1.5)
 hold on
 plot(time,ss21/scale12,'Color',[0.0 0.8 0.9],'LineWidth',0.5)
 hold on
 ...
 xlim([0 tmax])
 box on
 xlabel('Time [sec]','Fontsize', 16),ylabel('rates','Fontsize', 16)
