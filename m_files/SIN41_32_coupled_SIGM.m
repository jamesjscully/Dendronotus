...
% Initial values
V4= -44; V1= -44; Ca4=.11; Ca1=1.3; h4 =0; h1 =0; n4 =0; n1 =0; 
...
subplot(6,1,1)
 plot(time,vv1,'Color',[0 .0 0.99]','LineWidth',1.5)
 hold on
...
xlabel('Time [sec]','Fontsize', 16),ylabel('Si2L/Si3R','Fontsize', 16)
 ...
 xlim([0 tmax]) 
 ylim([-80 40])
xlabel('Time [sec]','Fontsize', 16),ylabel('Si2L/Si4R','Fontsize', 16)

 subplot(6,1,2)
 plot(time,vv2,'Color',[0 .0 0.6]','LineWidth',1.5)
 hold on
 xlim([0 tmax]) 
 ylim([-80 50])
