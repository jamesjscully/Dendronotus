...
%txpo = text(-4.4,25,'B','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')
 ...
 subplot(6,1,5)
 plot(time,ss4/scale4,'Color',[0.6 0.0 0.],'LineWidth',1.5)
 hold on
 plot(time,ss1/scale1,'Color',[0.0 0.  0.6],'LineWidth',1.5)
 hold on
 plot(time,ss12/scale12,'Color',[0.0 0.5 0.0],'LineWidth',0.1)
 hold on
 plot(time,ss43/scale34,'Color',[0.1 0.1 0.1],'LineWidth',0.1)
 hold on
 ylim([-0.2  .9])
 xlim([0 tmax])
 box on
