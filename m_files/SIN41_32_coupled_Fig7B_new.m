...
V1= V1 +step*(0*Iapp*heaviside(tt-t1)*heaviside(t2+150-tt)+4*((0.1*(50-(127*V1/105+8265/105))/(exp((50 - (127*V1/105 ...
...
V2= V2 +step*(0*Iapp*heaviside(tt-t1)*heaviside(t2-tt)+4*((0.1*(50-(127*V2/105+8265/105))/(exp((50 - (127*V2/105 ...
    ...
    -0.0*g32*(V2-30)*s3/scale3 -0*g12*(V2+80)*s12/scale12 +0*gelec*(V3-V2)+rnd2(i));

V3 =V3 +step*(Iapp*heaviside(tt-t1)*heaviside(t2-50000-tt)+4*((0.1*(50-(127*V3/105+8265/105))/(exp((50 - (127*V3/105 ...
