...
% V1= si2L V2=si2R  V3=Si3L  V4=Si3R

% fast inhinition alpha syn ----- between 43 Si3s---------------
alpha34=0.005;
beta34 =0.005;
...
% fast inhinition alpha syn ----- between 1 and 2 Si2s----
alpha12=0.005;
beta12= 0.005;
...
% excitation from Si3s onto Si2s 
% decreasing it makes the betwork bursting slower!!
g41=0.005; g32=g41; 
% Normal swim g41=0.01
% try g41=0.01 

% inhinition from Si2s onto Si3s 
g14=0.01;  g23=g14;
%Normal swim g14=0.01
...
V3= -44; V2= -44; Ca3=.1; Ca2=1.5; h3 =0; h2 =0; n3 =0; n2 =0; 
...
V3 =V3 +step*(4*((0.1*(50-(127*V3/105+8265/105))/(exp((50 - (127*V3/105 ...
    ...
    +0.03*Ca3/(.5 + Ca3)*(-75 - V3)+0.003*(-40 - V3) -g23*(V3+80)*s2/scale2 -g43*(V3+80)*s43/scale34  +gelec*(V2-V3)+rnd1(i));
...
V1= V1 +step*(4*((0.1*(50-(127*V1/105+8265/105))/(exp((50 - (127*V1/105 ...
    ...
    -g41*(V1-30)*s4/scale4  -g21*(V1+80)*s21/scale12  +gelec*(V4-V1)+rnd2(i));
...
% can be changed from 0.03 through 0.00003
Ca4=Ca4+step*(0.00003*(0.0085*x4*(140-V4+Ca_shift4)-Ca4));
Ca1=Ca1+step*(0.00003*(0.0085*x1*(140-V1+Ca_shift1)-Ca1));
Ca3=Ca3+step*(0.00003*(0.0085*x3*(140-V3+Ca_shift3)-Ca3));
Ca2=Ca2+step*(0.00603*(0.0085*x2*(140-V2+Ca_shift2)-Ca2));
...
%%
 ...
 hold on
 plot(time,vv1+15,'Color',[0 .0 0.99]','LineWidth',1.)
 hold on
 xlabel('Time [sec]','Fontsize', 16),ylabel('V1','Fontsize', 16)
 xlim([0 tmax]) 
 ylim([-80 50])
xlabel('Time [sec]','Fontsize', 16),ylabel('Si2L/Si3R','Fontsize', 16)
%fftt = 28;
%txpo = text(-4.4,25,'B','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')
 ...
 hold on
 plot(time,vv2+15,'Color',[0 .0 0.6]','LineWidth',1.)
 hold on
 xlim([0 tmax]) 
 ylim([-80 50])
xlabel('Time [sec]','Fontsize', 16),ylabel('Si2R/Si3L','Fontsize', 16)
 ...
 hold on
 plot(time,ss12/scale12,'Color',[0.0 0.0 0.5],'LineWidth',0.5)
 hold on
 plot(time,ss34/scale34,'Color',[0.5 0.0 0.1],'LineWidth',0.5)
 hold on
 ylim([-0.1  .9])
 xlim([0 tmax])
 box on
