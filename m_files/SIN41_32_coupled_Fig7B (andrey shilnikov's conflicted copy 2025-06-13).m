...
t2=65*1000; % this time is in msec
...
V3 =V3 +step*(0*Iapp*heaviside(tt-t1)*heaviside(t2-tt)+4*((0.1*(50-(127*V3/105+8265/105))/(exp((50 - (127*V3/105 ...
...
s3 =s3+step*(alpha3*s3*(1-s3)/(1+exp(-20*(V3+0)))-beta3*(s3-0.0001));
