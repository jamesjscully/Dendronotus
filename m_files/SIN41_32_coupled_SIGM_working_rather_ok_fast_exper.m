...
%%
 ...
 clf
 subplot(6,1,1)
 plot(time,vv4+15,'Color',[0.9 0  0]','LineWidth',1.5)
 hold on
 plot(time,vv1,'Color',[0 .0 0.99]','LineWidth',1.)
 hold on
...
%txpo = text(-4.4,25,'B','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')
 ...
 subplot(6,1,2)
 plot(time,vv3+15,'Color',[0.6 0  0]','LineWidth',1.5)
 hold on
 plot(time,vv2,'Color',[0 .0 0.6]','LineWidth',1.)
 hold on
 xlim([0 tmax]) 
 ylim([-80 50])
