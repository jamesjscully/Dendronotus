...
V1= V1 +step*(4*((0.1*(50-(127*V1/105+8265/105))/(exp((50 - (127*V1/105 ...
    ...
    (4*exp((25 - (127*V1/105 + 8265/105))/18))))^3*h1*(30 - V1) + 0.3*n1^4*(-75 - V1)+0.01*x2*(30-V1) ...
...
Ca1=Ca1+step*(0.0003*(0.0085*x2*(140-V1+Ca_shift1)-Ca1));
...
x2 =x2+step*(((1/(exp(0.15*(-V1-50+x_shift))+1))-x2)/100);
...
if mod(i,is) ==0
    ...
    Caa1(j)=Ca1; xx4(j)=x4; xx2(j)=x2; heavy(j)=heav(i);
    vv3(j)=V3; vv2(j)=V2; ss3(j)=s3; ss2(j)=s2; Caa3(j)=Ca3;
    Caa2(j)=Ca2; xx3(j)=x3; xx2(j)=x2; 
...
%txpo = text(-4.4,25,'B','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')
 xlabel('Time [sec]','Fontsize', 16),ylabel('V4','Fontsize', 16)

 subplot(8,1,2)
 plot(time,vv3,'Color',[0 0  .9]','LineWidth',1.5)
 hold on
 xlim([0 tmax]) 
 ylim([-80 40])
xlabel('Time [sec]','Fontsize', 16),ylabel('V3','Fontsize', 16)


 subplot(8,1,3)
 plot(time,vv1,'Color',[0 .6 0]','LineWidth',1.5)
 hold on
 xlabel('Time [sec]','Fontsize', 16),ylabel('V1','Fontsize', 16)
 xlim([0 tmax]) 
 ylim([-65 40])

 subplot(8,1,4)
 plot(time,vv2,'Color',[0 .99 0.0]','LineWidth',1.5)
 hold on
  xlabel('Time [sec]','Fontsize', 16),ylabel('V2','Fontsize', 16)
 xlim([0 tmax]) 
 ylim([-65 40])


 subplot(8,1,5)
 plot(time,ss4/scale4,'Color',[0.0 0.0 0.6],'LineWidth',1.5)
 hold on
 plot(time,ss1/scale1,'Color',[0.0 0.6 0.0],'LineWidth',1.5)
 hold on
 ylim([-0.02  .1])
 xlim([0 tmax])
 box on
 ...
 subplot(8,1,6)
 plot(time,ss3/scale3,'Color',[0.0 0.0 0.99],'LineWidth',1.5)
 hold on
 plot(time,ss2/scale2,'Color',[0.0 0.9 0.0],'LineWidth',1.5)
 hold on
 ylim([-0.02  .1])
 xlim([0 tmax])
 box on
...
subplot(8,1,7)
 plot(time,Caa4,'Color',[0. 0.0 0.6],'Linewidth',1.5)
 hold on
 plot(time,Caa1,'Color',[0.0 0.6 0.0],'Linewidth',1.5)
 hold on
 ylim([0.3 1.4])
 xlim([0 tmax])
...
subplot(8,1,8)
 plot(time,Caa3,'Color',[0. 0.0 0.99],'Linewidth',1.5)
 hold on
 plot(time,Caa1,'Color',[0.0 0.9 0.0],'Linewidth',1.5)
 hold on
 ylim([0.3 1.4])
 xlim([0 tmax])
 xlabel('Time [sec]','Fontsize', 16),ylabel('[Ca 4/1]','Fontsize', 16)
 ...
 plot(Caa4(st:end),xx4(st:end),'Color',[0. 0. 0.6],'LineWidth',2)
  hold on
  plot(Caa1(st:end),xx2(st:end),'Color',[0.1 0.6 0.1],'LineWidth',2)
  hold on
...
pos=length(xx4);
  ...
  hold on
  plot(Caa1(pos),xx2(pos),'.','Color',[0. 0.99 0.],'MarkerSize',50)
  hold on
plot(Caa4(pos),xx4(pos),'.','Color',[0.5 0.7 1],'MarkerSize',40)
  hold on
  plot(Caa1(pos),xx2(pos),'.','Color',[0. 0.7 0.],'MarkerSize',40)
  hold on
   plot(Caa4(pos),xx4(pos),'.','Color',[0.1 0.1 .5],'MarkerSize',20)
  hold on
  plot(Caa1(pos),xx2(pos),'.','Color',[0. 0.5 0.],'MarkerSize',20)
  hold on 
