...
t1=0*1000; % this time is in msec
t2=10*1000; % this time is in msec
...
V0= -45; Ca0=.5; h0 =0; n0 =0; s0=0; x0=0.0;
...
vv3=time;vv2=time;ss3=time;ss2=time;Caa3=time; Caa0=time;
Caa2=time;xx3=time;xx2=time; ss12=time; ss21=time; ss34=time; ss43=time;
Caa0=time;xx0=time;vv0=time;ss0=time; xx0=time;
...
Ca0=Ca0+step*(0.00002*(0.0085*x0*(140-V0+Ca_shift0)-Ca0)); 
...
if mod(i,is) ==0
    j=j+1;
    time(j)=tt; vv4(j)=V4; vv1(j)=V1; ss4(j)=s4; ss1(j)=s1; Caa4(j)=Ca4;Caa0(j)=Ca0;
...
%txpo = text(-4.4,25,'B','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')
 ...
 plot(Caa4(st:end),xx4(st:end),'Color',[0.6 0. 0.],'LineWidth',2)
  ...
  hold on
  plot(Caa0(st:end),xx0(st:end),'Color',[0.1 0.2 0.1],'LineWidth',2)
  hold on
