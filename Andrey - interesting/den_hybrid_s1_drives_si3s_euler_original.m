...
V2= V2 +step*(4*((0.1*(50-(127*V2/105+8265/105))/(exp((50 - ...
    ...
    -0.01*g13*(V2-55)*se-g12*(V2+80)*s1^2*m1+gelec*(V3(i)-V2)+noise*(rand-0.5));
...
%   subplot(4,1,4)
%   plot(time-t0,mm1.*ss1,'blue')
%   hold on
%   %plot(time,ss1,'Color',[0.5 0.5 0.5])
%   hold on
%   plot(time-t0,ss2.*mm2,'Color',[0.0 0.58 0.0])
%   hold on
%   plot(time-t0,see,'Color',[0.1 0.1 0.1])
%   hold on 
%   %ylim([0 .02])
%   xlim([0 t_final])
%   %xlim([100 110]) 
%  %   title('s(t) probability of neuro-transmitter release', 'Fontsize', 14);
  ...
  figure(6)
  clf
  plot(vv1,V3,'b','LineWidth',1.)
  hold on
  plot(vv2,V3,'green','LineWidth',1.)
  hold on
  norm(vv2)
  norm(vv1)
